...
\begin{equation}
\mNewTypeDecl\textit{Fn}\mA \mB ={}^\textit{Fn}\{\mathit{run}\mIn\mProjEXP{\mA }{\mB }\}
\end{equation}

\begin{multline}
  \mInstanceDecl\mTypeClass{Arrow}{}\textit{Fn}\\
  \mWhere\left\{
  \begin{aligned}
...
\begin{equation}
  \mInstanceDecl\mTypeClass{Category}\mathit{Fn}\mWhere
  \left\{
  \begin{aligned}
