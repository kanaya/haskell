...
% Type classes
\newcommand{\mTypeClass}[1]{\textbf{\textit{#1}}}%{\textsc{#1}} % Inetrnal use
...
型コンストラクタ&&$\mPolymorphicTypeParameter{f},\mPolymorphicTypeParameter{g},\mPolymorphicTypeParameter{h}$\\
有名な型コンストラクタ&&$\mListTypeConstructor,\mMaybeTypeConstructor$\\
