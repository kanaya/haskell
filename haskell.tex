...
\DeclareMathOperator{\mUnsplit}{\mSpecialFunc{unsprit}}
...
\newcommand{\mFuncType}[2]{\langle\mType{#1}\mMapsTo\mType{#2}\rangle}
...
関数 $\mA\mMapsTo\mB$ の代わりに，射 $\mA\mCatMapsTo\mB$ を考える．
...
\begin{align}
  ...
  \mMapsTo(\mA\mCatMapsTo\mB)
  \mMapsTo(\mA\mCatMapsTo\mC)
\end{align}
...
\begin{equation}
  ...
  \begin{aligned}
    ...
    (\mCompCat)
    &\mIn{}(\mX\mCatMapsTo\mY)\mMapsTo(\mX\mCatMapsTo\mY)\mMapsTo(\mX\mCatMapsTo\mY)
  \end{aligned}
  \right.
\end{equation}
