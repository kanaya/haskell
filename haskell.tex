...
多相型&&$\hTypeConstruct{\hTypeConstructor{m}}{\hTypeName{a}}$\\
...
\hline
$\hPureWith{\hVar{x}}$&ピュア演算子&\code{pure x}\\  %%% ???
$\hReturnWith{\hVar{x}}$&&\code{return x}\\  %%% ???
