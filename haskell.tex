...
\begin{align}
  ...
  \mathbf{y}&=\mathbf{f}\mathop{\texttt{=<<}}\mathbf{x}
\end{align}

\begin{align}
  z&=gxy\\
  \mathbf{z}&=\mathbf{g}xy\\
  \mathbf{z}&=g\mathop{\texttt{<\$>}}\mathbf{x}\mathop{\texttt{<*>}}\mathbf{y}\\
  \mathbf{z}&=(\backslash y'\rightarrow(\backslash x'\rightarrow\mathbf{g}x'y')\mathop{\texttt{=<<}\mathbf{x}})\mathop{\texttt{=<<}\mathbf{y}}\\
    &=\mathop{\text{do}}\{x'\leftarrow\mathbf{x};\;y'\leftarrow\mathbf{y};\;\mathbf{g}x'y'\}
\end{align}

\begin{align}
  f\mathop{\texttt{<\$>}}\mathbf{x}&=\mathop{\text{pure}}f\mathop{\texttt{<*>}}\mathbf{x}
\end{align}
